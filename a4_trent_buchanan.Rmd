...
The relationship between observed juvenile hares' hind foot length (mm) and weight (g) appears positive across all trapping sites, and may be linear but is not strong. 
...
ggplot(data = foot_weight, 
  ...
  labs(x = "Hind Foot Length (mm)",
       y = "Weight (g)",
       title = "Hind foot length vs. weight in juvenile hares with linear regression line",
       tag = "Figure 4",
