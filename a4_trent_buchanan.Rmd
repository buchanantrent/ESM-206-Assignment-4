...
The relationship between observed juvenile hares' hind foot length (mm) and weight (g) appears positive across all trapping sites. 
...
ggplot(data = foot_weight, 
  ...
  labs(x = "Hind Foot Length (mm)",
       ...
       tag = "Figure 4",
       caption = "Figure 4. Linear regression line added to observed hind foot length and weight of juvenile Snowshoe Hares.\nData: Kielland et al. (2017).") +
  scale_x_continuous(breaks = seq(60,160,20)) +
  scale_y_continuous(breaks = seq(0,1700,200)) +
  theme_bw()
